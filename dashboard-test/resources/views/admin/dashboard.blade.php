                        ...
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    ...
                                    <h3 class="m-b-0">{{showAmount($deposit['total_deposit_amount'])}}</h3>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    ...
                                    <h3 class="m-b-0">{{showAmount($deposit['total_deposit_charge'])}}</h3>
                                </div>
                                <div class="col-auto">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="" class="float-end" target="_blank">@lang('View all')</a>
                </div>
